...
public class RedObjectPipeline extends OpenCvPipeline {
    ...
    private volatile RedObjectPipeline.ElementPosition position = RedObjectPipeline.ElementPosition.LEFT;
    ...
    public Mat processFrame(Mat input) {
        ...
        {
            position = RedObjectPipeline.ElementPosition.CENTER; // Record our analysis
            Element_Position = 2;
            /*
        ...
        {
            position = RedObjectPipeline.ElementPosition.RIGHT; // Record our analysis
            Element_Position = 3;
     ...
     */
    public RedObjectPipeline.ElementPosition getAnalysis() {
        return position;
    }
}